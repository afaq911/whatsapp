...
const Nodata = () => {
  return (
    <div className={styles.no_data_container}>
      ...
      <div className={styles.nodata_info}>
        <h2>ChitChat Web</h2>
        <p>
          Send and receive messages without keeping your phone online. <br />
          Use Chit-Chat on your desktop or mobile & chat with your fav persons.
        </p>
      </div>
      <label className={styles.nodata_secured}>
        <HttpsIcon /> <p>End to end encrypted</p>
      </label>
    </div>
  );
};
